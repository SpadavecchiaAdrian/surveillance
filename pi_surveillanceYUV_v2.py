...
for f in camera.capture_continuous(rawCapture, format="yuv", use_video_port=True):
    ...
    gray = f.array[:, :, 0]  # accedemos a todas las filas, columnas del canal Y
    gray_fresh = gray.copy()
    ...
    cv2.putText(gray_fresh, ts, (10, gray_fresh.shape[0] - 10), cv2.FONT_HERSHEY_SIMPLEX,
                0.35, (0xff), 1)
    ...
    if conf["show_video"]:
        ...
        cv2.imshow("Security Feed", gray_fresh)
